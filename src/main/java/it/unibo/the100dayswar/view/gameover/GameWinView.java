...
public class GameWinView extends JFrame {
    ...
    /**
     * Constructor for the GameWinView.
     */
    public GameWinView() {
        super("Victory!");
    }
     ...
     */
    private void setUI() {
        final Image backgroundImg = loadImage("/gameover/win.png");
        ...
        final JLabel message = new JLabel("Congratulations, you won!", JLabel.CENTER);
     ...
     * @return the loaded image, or null if there's an error
     */
